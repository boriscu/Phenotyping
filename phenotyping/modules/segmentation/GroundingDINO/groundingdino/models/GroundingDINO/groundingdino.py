...
from phenotyping.modules.segmentation.GroundingDINO.groundingdino.util import (
    box_ops,
    get_tokenlizer,
)
...
from phenotyping.modules.segmentation.GroundingDINO.groundingdino.util.visualizer import (
    COCOVisualizer,
)
from phenotyping.modules.segmentation.GroundingDINO.groundingdino.util.vl_utils import (
